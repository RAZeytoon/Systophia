...
---
#تحلیل_پیوندی #Q_Analysis #تحلیل_شبکه #پیچیدگی #تحلیل_شهری #تحلیل_سیستم

مرتبط: [[تحلیل کردن، تمامیت‌ها را خراب می‌کند]] (آیا تحلیل واقعاً تمامیت را خراب می‌کند، یا فقط تحلیلِ فروکاسته‌ی گراف‌محور؟)، [[تئوری مشاهده‌پذیری چندوجهی؛ وقتی هیچ آینه‌ای به‌تنهایی تمام چهره را نشان نمی‌دهد (Multi-perspective Observability)|تئوری مشاهده‌پذیری چندوجهی]] (هر دو به دنبال دیدنِ ساختار پنهانی هستند که در نگاه ساده و تخت گم می‌شود)، و [[نظریه اول یا داده اول؛ دو نگاه به تحلیل داده]] (اینجا هم دقیقاً همون انتخاب مطرحه: چارچوب نظری از پیش، یا کشفِ ساختار از دلِ داده؟).